...
val_array= ["number_one","number_two","number_three","number_four","number_five","number_six","number_seven","number_eight","number_nine"]
...
def reset():
    global val_array
    val_array= ["number_one","number_two","number_three","number_four","number_five","number_seven","number_six","number_eight","number_nine"]
